...
class TaskCollectionViewController: UICollectionViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //self.collectionView!.register(TaskCollectionViewCell.self, forCellWithReuseIdentifier: "taskCell")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail" {
            if let indexPath = collectionView.indexPathsForSelectedItems {
                let object = fetchedResultsController.object(at: indexPath[0])
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
     ...
     //   cell.dateLabel.text = "Some text" //event.timestamp!.description
        cell.labelDate!.text = event.timestamp!.description
        return cell
    }
...
//private extension TaskCollectionViewController {
