...
extension ScaleDateComponentPickerController {
    ...
    func setScaleDateComponent(component:ScaleDateComponentPickerController.Component, scale: Int) {
    ...
    func getComponent() -> ScaleDateComponentPickerController.Component {
        let row = self.picker?.selectedRow(inComponent: 1) ?? 0
        return ScaleDateComponentPickerController.Component(rawValue: row) ?? .Week
    }
}
...
extension ScaleDateComponentPickerController : UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        let component = ScaleDateComponentPickerController.Component(rawValue: pickerView.selectedRow(inComponent: 1))
